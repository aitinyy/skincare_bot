...
app.post("/echo", function(req, res){
    ...
    function manageEnhancingBeauty(makeupType2){
        ...
        switch (makeupType2){
            case 'Colorete':
                speech = 'Hay distintas formas de utilizarlo. Para empezar, el tono es gusto personal, pero la posición en la cara va a influir. Para un efecto lifting, se debe aplicar por arriba de los pómulos. Para hacer más pequeña la cara, se debe aplicar en medio de la mejilla.';
                break;
            case 'Bronceador':
                speech = 'Se utiliza para esculpir el rostro. Debe de ser unos tonos más oscuros a tu piel y se necesita una brocha fina. Se puede usar bajo en los pómulos para marcarlos. En el puente de la nariz, dejando un hueco en medio, para una apariencia más pequeña. También en la parte superior la frente para hacerla más pequeña también. Y en el borde de la mandíbula para hacer la cara más pequeña. ';
                break;
            case 'Iluminador':
                speech = 'Se utiliza para realzar alguna parte de la cara. Se necesita una brocha pequeña con la que difuminar. Se puede utilizar en el centro de la nariz para hacerla más puntiaguda. También se puede poner en el puente de la nariz, haciendo una sutil línea y da la apariencia la nariz más pequeña. Se puede aplicar un poco en los labios para hacerlos más grandes. En la parte superior del pómulo da un look radiante.';
                break;
            default:
                speech = '¿Disculpa?';
                break;
